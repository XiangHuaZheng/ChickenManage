    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/chicken/dailysituationsummary/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.chickenName = data.dailysituationsummary.chickenName
                this.dataForm.batchId = data.dailysituationsummary.batchId
                this.dataForm.dailyDate = data.dailysituationsummary.dailyDate
                this.dataForm.breeder = data.dailysituationsummary.breeder
                this.dataForm.raiseDays = data.dailysituationsummary.raiseDays
                this.dataForm.chickenNum = data.dailysituationsummary.chickenNum
                this.dataForm.dieNum = data.dailysituationsummary.dieNum
                this.dataForm.outNum = data.dailysituationsummary.outNum
                this.dataForm.sellNum = data.dailysituationsummary.sellNum
                this.dataForm.inNum = data.dailysituationsummary.inNum
                this.dataForm.eggNum = data.dailysituationsummary.eggNum
                this.dataForm.earlyTemp = data.dailysituationsummary.earlyTemp
                this.dataForm.medTemp = data.dailysituationsummary.medTemp
                this.dataForm.lateTemp = data.dailysituationsummary.lateTemp
                this.dataForm.earlyHumidity = data.dailysituationsummary.earlyHumidity
                this.dataForm.medHumidity = data.dailysituationsummary.medHumidity
                this.dataForm.lateHumidity = data.dailysituationsummary.lateHumidity
                this.dataForm.epidemicPreventionRecord = data.dailysituationsummary.epidemicPreventionRecord
                this.dataForm.medicationRecord = data.dailysituationsummary.medicationRecord
                this.dataForm.feedIntake = data.dailysituationsummary.feedIntake
                this.dataForm.disinfect = data.dailysituationsummary.disinfect
                this.dataForm.remarks = data.dailysituationsummary.remarks
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/chicken/dailysituationsummary/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
